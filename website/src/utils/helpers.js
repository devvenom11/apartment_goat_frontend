...
export async function getData(
  ...
  try {
    ...
    const res = await fetch(
      `${API_URL}/api${slug}${fetchAll ? "?populate=*" : "?"}${queryString}`
    );
    if (!res.ok) {
...
//     // Fetch each image and append it to the form data
...
//     }
//     console.log("Formated Images", formData);
