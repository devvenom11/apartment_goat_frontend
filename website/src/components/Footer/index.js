        ...
        <div className="w-full flex flex-wrap items-start justify-between pb-[42px] lg:pb-[65px] gap-y-8 ">
          ...
          <div className="w-full md:w-[66%] lg:w-fit flex flex-row lg:flex-col gap-y-4">
            ...
            <div className=" pl-2 md:pl-0">
              ...
              <ul className="w-full flex flex-col gap-y-4">
                <Link href={"/apartments/albany-park-chicago-il?type=houses"}>
                  <li className="text-sm text-[#5C5C6C] font-medium">
                    Houses for Rent
                  </li>
                </Link>
                ...
                <Link href={"/apartments/albany-park-chicago-il?type=condos"}>
                  <li className="text-sm text-[#5C5C6C] font-medium">
                    Condos for Rent
                  </li>
                </Link>
                <Link href={"/apartments/albany-park-chicago-il?type=rooms"}>
                  <li className="text-sm text-[#5C5C6C] font-medium">
                    Room for Rent
                  </li>
                </Link>
