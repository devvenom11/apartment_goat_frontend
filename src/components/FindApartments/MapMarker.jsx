...
const MapMarker = ({ handleMarkerClick, item, selectedMarker }) => {
  ...
  return (
    <div
      ...
      className={`relative inset-0 m-auto h-6 group -translate-y-1/2 -translate-x-1/2 flex min-h-[28px] max-h-[28px] w-[78px] max-w-[370px] px-2 items-center justify-center cursor-pointer rounded-[20px] shadow-[0px_2px_8px_rgba(21,26,29,0.15)] border-none  hover:bg-brand hover:text-white hover:z-50 ${isSelected ? "bg-brand text-white z-50" : "bg-white"}`}
    >
      <div
