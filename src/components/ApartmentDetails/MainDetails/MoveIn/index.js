  ...
  return (
    data && (
      <div className="w-full">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-end pt-4" >
          <div className="mb-4 md:mb-0 text-brand text-base font-normal leading-6">
            <address className="cursor-pointer not-italic hover:underline">
              ...
              <div className="flex items-center leading-6 text-gray-700">
                {data.state?? ''},
                  <span className="px-1">{data.city}</span>
                  <div className="px-2">
                    <svg
                      width={6}
                      height={6}
                ...
                <span className="mx-1.5 block h-[16px] w-[1px]   bg-[#DBDBDB]"></span>
                {data.bedrooms} bed
                <span className="mx-1.5 block h-[16px] w-[1px]   bg-[#DBDBDB]"></span>
                {data.bathrooms} bath
              </div> 
