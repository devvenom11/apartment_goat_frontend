...
const Neighborhood = () => { 
  ...
  return (
    <div id="neighborhood-section"   className="mb-8 md:mb-9 md:border-b md:border-b-border-light md:pb-[42px]">
      <h3 className="px-5 text-2xl font-bold md:px-0">Neighborhood</h3>
      <div className="w-full  md:mt-4 relative rounded-[16px]">
        <div className="flex md:absolute px-2 z-[3] py-4 md:py-4 left-0 top-0 overflow-scroll w-full">
