...
const PropertyDetails = ({ data }) => {
  ...
  return (
    <>
      <div
        className="min-h-[192px] gap-4 rounded border border-[#EAEBEB] px-6 pb-5 pt-[19px] shadow-[0px_2px_8px_rgba(21,26,29,0.08)] md:w-[335px] mx-5 mb-8 mt-6 md:hidden"
      >
        <div className="mb-1 flex h-6 justify-center text-xl font-medium leading-6">
          Ready to apply?
        </div>
        <div className="mb-2 text-center leading-6 text-gray-lh-700">
          Don't forget to select “Apartment locator” as who referred you on your
          application to be eligible to receive a Free Move or $200 Rebate.
        </div>
