...
const LatestApartmentsBlogCards = ({ data, loading }) => {
  const CardsData = [
    {
      color: "#3987FF",
    },
      ...
      <div className="px-[16px] lg:px-[0px]">
        <div className="mt-[64px]">
          <p className="text-[24px] font-[600] leading-[36px] text-[#22223B]">
            The latest from ApartmentGoats
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-[24px] gap-[16px] ">
          {loading &&
...
export default LatestApartmentsBlogCards;
const LoadingCard = () => {
  return (
