...
export async function GET(req: Request) {
  try {
    ...
    console.log('Request Parameters:', { neighborhood, city, page, limit });

    // Construct the external API URL
    const apiUrl = new URL('https://api.dibze.com/api/v1/search/neighborhood');
    apiUrl.searchParams.append('neighborhood', neighborhood);
    apiUrl.searchParams.append('city', city);
    apiUrl.searchParams.append('page', page);
    apiUrl.searchParams.append('limit', limit);

    // Log the full API URL for debugging
    console.log('External API URL Neighbor-:', apiUrl.toString());
    ...
    console.log('NEIGHBOR API RESPONSE:', data); // Log the response for debugging
